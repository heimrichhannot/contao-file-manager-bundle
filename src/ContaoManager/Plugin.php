...
namespace HeimrichHannot\FileManagerBundle\ContaoManager;
...
use HeimrichHannot\FileManagerBundle\HeimrichHannotFileManagerBundle;
...
class Plugin implements BundlePluginInterface, ConfigPluginInterface, RoutingPluginInterface
{
    ...
    {
        return [
            BundleConfig::create(HeimrichHannotFileManagerBundle::class)->setLoadAfter([
